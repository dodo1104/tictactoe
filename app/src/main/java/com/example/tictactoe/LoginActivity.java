...
public class LoginActivity extends AppCompatActivity implements FragmentBackgrounds.fragInterface ,Dialog1.MyDialogFragmentListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        playerX = (ImageView)findViewById(R.id.imageX);
        playerO = (ImageView)findViewById(R.id.imageO);
    ...
    @Override
    public void onReturnValue(String icon, int i) {//Dialog1 - Icons for X and O
        if(i == 0){
